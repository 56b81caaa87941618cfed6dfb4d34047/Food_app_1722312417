...
*/
Vue.component("simple_footer_component_1722312418", {
    template: `
    <footer id="footer-section" class="flex-1 bg-red-600 dark:bg-red-600">
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Revolutionizing the food industry through transparency and traceability. Powered by blockchain technology.
                    </div>
                </div>
            </div>
        </footer> 
